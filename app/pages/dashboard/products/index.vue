              ...
              <DialogPanel class="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-h-[90vh] overflow-y-auto">
                ...
                <form @submit.prevent="handleSubmit">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- SKU (Reference) - Auto-generated from name -->
                    <div>
                      ...
                      <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        {{ $t('products.skuAutoGenerated') || $t('products.skuHint') }}
                      </p>
                    </div>
...
watch(() => form.value.name, (newName) => {
  // Only auto-generate if not editing and SKU hasn't been manually edited
  if (!editingProduct.value && !skuManuallyEdited.value) {
    form.value.reference = generateSkuFromName(newName)
  }
})
...
const isFormValid = computed(() => {
  if (!form.value.name.trim() || !form.value.reference.trim()) {
    return false
  }
    ...
    if (editingProduct.value) {
      ...
      if (form.value.hasVariants && variantsToCreate.value.length > 0) {
        try {
          ...
          // Invalidate products cache to reflect hasVariants=true and variantCount
          invalidate()
