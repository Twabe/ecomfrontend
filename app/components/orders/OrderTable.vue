        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-4 py-3 text-sm">
              <!-- Show provider city if assigned -->
              <div v-if="order.providerCityName" class="text-green-600 dark:text-green-400 font-medium">
                {{ order.providerCityName }}
              </div>
              ...
              <div v-if="order.sourceCity && order.sourceCity !== order.providerCityName && order.sourceCity !== order.cityName" class="text-xs text-amber-600 dark:text-amber-400">
                ({{ order.sourceCity }})
              </div>
            </td>
            <td class="px-4 py-3">
